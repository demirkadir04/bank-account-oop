...
def rotate_angle_right():
   #same as turtle_instance.right(10)
    turtle_instance.setheading(turtle_instance.heading()-10)

def rotate_angle_left():
    #same as turtle_instance.left(10)
    turtle_instance.setheading(turtle_instance.heading()+10)
...
drawing_board.onkey(fun=turtle_forward, key="space") #Do not add parentheses when assigning functions.
